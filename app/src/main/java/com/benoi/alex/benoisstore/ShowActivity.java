...
import com.benoi.alex.benoisstore.data.ProductContract;
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            switch (currentSupplierName) {
                case ProductContract.ProductEntry.SUPPLIER_FLIPKART:
                    mProductSupplieNameSpinner.setText(getText(R.string.supplier_flipkart));
                    break;
                case ProductContract.ProductEntry.SUPPLIER_AMAZON:
                    mProductSupplieNameSpinner.setText(getText(R.string.supplier_amazon));
                    break;
                case ProductContract.ProductEntry.SUPPLIER_EBAY:
